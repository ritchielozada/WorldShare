...
/// </summary>
public class RemoteAvatarManager : Singleton<RemoteAvatarManager>
{
    ...
    void Start()
    {
        AnchorShareCustomMessage.Instance.MessageHandlers[AnchorShareCustomMessage.TestMessageID.HeadTransform] = this.UpdateHeadTransform;
    ...
    void Update()
    {
        ...
        AnchorShareCustomMessage.Instance.SendHeadTransform(headPosition, headRotation);
    }
